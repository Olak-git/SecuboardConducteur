...
const NotationPassagerView: React.FC<NotationPassagerViewProps> = ({ navigation, route }) => {
    ...
    const onHandle = () => {
        ...
        .catch(error => {
            setShow(false);
            console.log('NotationPassagerView Error1: ', error);
        })
    }
    ...
    const getDataUser = () => {
        ...
        .catch(error => {
            console.log('NotationPassagerView Error2: ', error)
        })
    }
            ...
            ?
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View style={tw`px-10 mt-10`}>
                        ...
                        <Button onPress={onHandle} mode='contained-tonal' loading={show} disabled={show} style={tw`rounded-lg`} labelStyle={tw`uppercase text-lg`}>Valider</Button>
                    </View>
